...
The the end, I applied my prediction algorithm to the testing dataset to predict the classe. And the result of prediction was presented as the following:
